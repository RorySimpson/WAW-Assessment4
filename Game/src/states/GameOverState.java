...
public class GameOverState extends BasicGameState {
	...
	public void enter(GameContainer gc, StateBasedGame sbg) {
		...
		// Check to see if a new global high score has been set (top 10
		// scores)
		...
		if (score >= lowestScore) {
			...
			nameTextField.setMaxLength(15); // Done for consistent
											// looks
	 ...
	 *            - player's name
	 * @param sbg
	 *            - StateBasedGame to be able to communicate with other states
	 */
	public void updateTextBox(Input input, StateBasedGame sbg) {
		...
		if (nameTextField.hasFocus()) {
			...
			/*
			 * When the enter key is pressed retrieve its text and reset the
			 * textbox
			 */
