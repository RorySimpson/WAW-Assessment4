...
public final class SplashState extends BasicGameState {
	...
	/* Attributes */
	private static Image splash, indicator;
	/*
	 * private static Color loadBaseColor = Color.white, loadFillColor =
	 * Color.black;
	 */
	...
	public void render(GameContainer gc, StateBasedGame s, Graphics g)
		...
		/*
		 * Draw the background image and get the loading bar working to properly
		 * display the amount of remaining resources to load
		 */
		g.drawImage(splash, 0, 0);
		indicator.drawCentered(
				900 - ((600 * loading.getRemainingResources()) / loading
						.getTotalResources()), 390);
	}
