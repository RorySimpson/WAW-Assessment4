...
public class MenuState extends BasicGameState {
	...
	/* Images */
	private static Image menuBackground, playButton, quitButton, creditsButton,
			controlsButton, scoreButton, achieveButton, playHover, quitHover,
			creditsHover, controlsHover, scoreHover, achieveHover;

	/* Hover images */
	private HoverImage play, quit, credits, controls, score, achieve;
	...
	public void init(GameContainer gc, StateBasedGame sbg)
		...
		loading.add(new DeferredResource() {
			...
			public void load() {
				...
				controls = new HoverImage(controlsButton, controlsHover, 490,
						533);
