...
public class PlayCoopState extends PlayState {
	...
	/**
	 * drawEventMessage: Draws relevant messages regarding the game state in the
	 * bottom bar.
	 */
	...
	public void drawEventMessage(GameContainer gc, Graphics g) {
		...
		for (Flight flight : airspace.getListOfFlights()) {
			...
			// Checks whether there is a plane waiting to take off
			// at left airport
		...
		// Checks whether a volcano eruption will occur within 10
		// seconds
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
		...
		// Otherwise draw main game
			...
			if (countdownToLightReduction != 0) {
				...
				// Checks when the brightness should start
				// increasing
				if (red == 40) {
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta)
		...
		// Checks if the game has been retried and if it has resets the
		// airspace
