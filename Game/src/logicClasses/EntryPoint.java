...
public class EntryPoint extends Point {
	...
	public void init(GameContainer gc) throws SlickException {
		...
		/**
		 * init: Initialises the variables and resources required for the
		 * EntryPoint object render (Sets EntryPoint Images)
		 * 
		 * @param gc
		 ...
		 */
		{
			...
			if (entryPointRight == null)
				loading.add(new DeferredFile(
						"res/graphics/entrypoint_right.png") {
					public void loadFile(String filename) throws SlickException {
	...
	/**
	 * render: Render method for the EntryPoint object, position determines
