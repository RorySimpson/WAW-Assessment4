...
public class Controls {
	...
	/* Whether the mouse is held down on a mouse to change the heading
	 * or if the heading has already been changed */
	...
	public void update(GameContainer gc, Airspace airspace) {
		...
		/* If the right button is pressed, it means the user is changing
