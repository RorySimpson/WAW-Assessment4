...
public class Airspace_Tests {
	...
	public void newWaypointTest() {
		...
		// tests that waypoint isn't added when outside range of the
		// airspace.
	...
	public void newExitPointTest() {
		...
		// tests that exitpoint isn't added when outside range of the
		// airspace.
	...
	public void newEntryPointTest() {
		...
		// tests that entrypoint isn't added when outside range of the
		// airspace.
