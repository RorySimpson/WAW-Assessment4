...
public class Flight_Tests {
	...
	public void generateAltitudeTest1() {
		// Testing the function returns an altitude within a certain
		// range.
	...
	public void calculateHeadingToFirstWaypointTest1() {
		...
		flight1.setX(150);
		flight1.setY(400);
		assertEquals(38.65, flight1.calculateHeadingToNextWaypoint(350, 150),
				0.01);
	...
	public void calculateHeadingToFirstWaypointTest2() {
		...
		flight1.setX(350);
		flight1.setY(400);
		assertEquals(321.34, flight1.calculateHeadingToNextWaypoint(150, 150),
				0.01);
	...
	public void checkIfFlightAtWaypointTest2() {
		// // Test that waypoint detection doesn't work further than 15
		// pixels away.
		Waypoint waypoint = new Waypoint(350, 150, "TEST");
		flight1.setX(1000);
		flight1.setY(1000);
	...
	public void checkIfFlightAtWaypointTest3() {
		// Test that waypoint detection works when close enough in terms
		// of
	...
	public void updateAltitudeTest2() {
		// Testing that the Flight doesn't move when at the target
		// altitude.
	...
	public void updateCurrentHeadingTest1() {
		// Test that the current heading moves towards the target
		// heading
