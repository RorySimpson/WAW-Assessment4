...
public class FlightPlanCompetitive_Tests {
	...
	public void assignEntryPointTest1(){
		...
		assertTrue(airspace.getListOfEntryPoints().get(0) == flight1.getFlightPlan().getEntryPoint());
		flight1.setPlayer2(false);
		flight1.getFlightPlan().assignEntryPoint(airspace);
		assertTrue(airspace.getListOfEntryPoints().get(1) == flight1.getFlightPlan().getEntryPoint());
