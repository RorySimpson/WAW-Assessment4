...
public class ScoreTracking_Test {
	...
	public void testUpdateScore() {
		...
		actualUpdatedScore = scoreTrackingInstance.updateScore(updatedScore, flight1.isBonus());
		actualUpdatedScore = scoreTrackingInstance.updateScore(anotherUpdatedScore, flight1.isBonus());
